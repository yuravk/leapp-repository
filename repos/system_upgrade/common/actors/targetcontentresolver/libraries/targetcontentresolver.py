...
from leapp.models import CustomTargetRepository, RepositoriesFacts, RepositoriesMapping, RepositoriesSetupTasks
...
def process():
    ...
    # so that all downstream stages operate on vendor-aware mapping data.
