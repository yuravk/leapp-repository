...
def _compute_packages_on_target_system(source_pkgs, events, releases):
    ...
    for release in releases:
        ...
        target_pkgs, pkgs_to_demodularize, pkgs_to_reinstall = _compute_pkg_changes_between_consequent_releases(
            target_pkgs, events,
            release, seen_pkgs,
            pkgs_to_demodularize
        )
...
def scan_pes_events(repomap_handler, blocklisted_repoids, enabled_repoids, installed_rpms, enabled_modules):
    ...
    target_pkgs, pkgs_to_demodularize, pkgs_to_reinstall = _compute_packages_on_target_system(
